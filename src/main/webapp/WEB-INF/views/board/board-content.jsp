...
<body>
    ...
    <div class="container">
        ...
        <div class="showBoardGroup">
            <div class="showBoard">
                ...
                <input type="text" name="writer" value="${b.writer}" placeholder="이름을 입력하세요" disabled>
            </div>
            ...
            <div class="showBoard">
                ...
                <input type="text" name="title" value="${b.title}" placeholder="글제목 입력하세요" disabled>
            </div>
            ...
            <div class="showBoard">
                ...
                <textarea id="content" name="content" disabled>${b.content}</textarea>
            </div>
    ...
    <script>
        ...
        const $delete = document.querySelector('#deleteBtn');
